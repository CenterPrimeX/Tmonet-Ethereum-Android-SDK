package com.centerprime.tmonet_ethereum_sdk;

import android.content.Context;
import android.os.Build;
import android.provider.Settings;

import com.centerprime.tmonet_ethereum_sdk.util.BalanceUtils;
import com.centerprime.tmonet_ethereum_sdk.util.CenterPrimeUtils;
import com.centerprime.tmonet_ethereum_sdk.util.Const;
import com.centerprime.tmonet_ethereum_sdk.util.Erc20TokenWrapper;
import com.centerprime.tmonet_ethereum_sdk.util.HyperLedgerApi;
import com.centerprime.tmonet_ethereum_sdk.util.SubmitTransactionModel;
import com.centerprime.tmonet_ethereum_sdk.util.Wallet;
...
public class EthManager {
    ...
    private void sendEventToLedger(HashMap<String, Object> map, Context context) {
        try {
            ...
            submitTransactionModel.setTx_type("TMONET_ETHEREUM");
