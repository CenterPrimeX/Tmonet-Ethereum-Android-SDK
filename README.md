# Tmonet-Ethereum-Android-SDK


## Table of Contents

- [Getting Started](#getting-started)
  - [Adding Tmonet Ethereum SDK as a Maven or Gradle Dependency](#adding-ethereum-sdk-as-a-maven-or-gradle-dependency)
...
<dependency>
	    ...
	    <artifactId>Tmonet-Ethereum-Android-SDK</artifactId>
...
```groovy
dependencies {
    implementation 'com.github.centerprime:Tmonet-Ethereum-Android-SDK:1.0.0'
}
```
...
*Congratulations!* Now you are a *CenterPrime - Tmonet* user.
